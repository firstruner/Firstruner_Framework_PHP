...
abstract class Headers_Code
{
    ...
    const TemporaryRedirection_Code = 302;
    ...
    public static function GetEnum(int $codeValue, bool $full = false)
    {
        switch ($codeValue) {
            ...
            case 302:
                return $full ? Headers_Code::TemporaryRedirection : Headers_Code::TemporaryRedirection_Code;
            case 401:
            ...
            default:
                return Headers_Code::$statusTexts[$codeValue];
        }
    }
}
