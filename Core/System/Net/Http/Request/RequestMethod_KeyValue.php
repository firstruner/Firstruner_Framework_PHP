...
final class RequestMethod_KeyValue
{
      public static function FULL():KeyValuePair {
            return new KeyValuePair(RequestMethodName::FULL,
            RequestMethod::FULL); }

      public static function GET():KeyValuePair {
            return new KeyValuePair(RequestMethodName::GET,
            RequestMethod::GET); }

      public static function POST():KeyValuePair {
            return new KeyValuePair(RequestMethodName::POST,
            RequestMethod::POST); }

      public static function PUT():KeyValuePair {
            return new KeyValuePair(RequestMethodName::PUT,
            RequestMethod::PUT); }

      public static function DELETE():KeyValuePair {
            return new KeyValuePair(RequestMethodName::DELETE,
            RequestMethod::DELETE); }



      public static function HEAD():KeyValuePair {
            return new KeyValuePair(RequestMethodName::HEAD,
            RequestMethod::HEAD); }

      public static function PATCH():KeyValuePair {
            return new KeyValuePair(RequestMethodName::PATCH,
            RequestMethod::PATCH); }

      public static function OPTIONS():KeyValuePair {
            return new KeyValuePair(RequestMethodName::OPTIONS,
            RequestMethod::OPTIONS); }

      public static function CONNECT():KeyValuePair {
            return new KeyValuePair(RequestMethodName::CONNECT,
            RequestMethod::CONNECT); }



      public static function TRACE():KeyValuePair {
            return new KeyValuePair(RequestMethodName::TRACE,
            RequestMethod::TRACE); }



      public static function READ():KeyValuePair {
            return new KeyValuePair(RequestMethodName::READ,
            RequestMethod::READ); }

      public static function CREATE():KeyValuePair {
            return new KeyValuePair(RequestMethodName::CREATE,
            RequestMethod::CREATE); }

      public static function UPDATE():KeyValuePair {
            return new KeyValuePair(RequestMethodName::UPDATE,
