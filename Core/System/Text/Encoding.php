...
{
    const UTF8 = UTF8::Name;
    const ASCII = ASCII::Name;
    const UTF16 = UTF16::Name;
    ...
    public static function GetBytes(string $string, string $encoding = self::UTF8): string
    {
    ...
    public static function GetString(string $bytes, string $encoding = self::UTF8): string
    {
    ...
    public static function GetStringFromBytes(string $bytes, string $encoding = self::UTF8): string
    {
    ...
    public static function GetBytesFromString(string $string, string $encoding = self::UTF8): string
    {
