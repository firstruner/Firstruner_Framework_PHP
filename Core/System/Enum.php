...
final class Enum // : ValueType, IComparable, ISpanFormattable, IConvertible
{
      // Notes:
      ...
      private const EnumSeparatorChar = ',';
      ...
      {
            foreach (Enum::extractEnumsKeyValues($enumName) as $_key => $_value)
      ...
      // public static function ToObject(Type $enumType, object $value)
      // {
      //       if ($value == null) throw new ArgumentNullException("value cannot be null");

      //       if (is_object($value)) return Enum::convertObjectToObject($value, )

      //       switch (Convert::GetTypeCode($value))
      //       {
      //             case TypeCode::Int32: return Enum::ToObject($enumType, $value);
      //             case TypeCode::SByte: return Enum::ToObject($enumType, $value);
      //             case TypeCode::Int16: return Enum::ToObject($enumType, $value);
      //             case TypeCode::Int64: return Enum::ToObject($enumType, $value);
      //             case TypeCode::UInt32: return Enum::ToObject($enumType, $value);
      //             case TypeCode::Byte: return Enum::ToObject($enumType, $value);
      //             case TypeCode::UInt16: return Enum::ToObject($enumType, $value);
      //             case TypeCode::UInt64: return Enum::ToObject($enumType, $value);
      //             case TypeCode::Single: return Enum::ToObject($enumType, BitConverter.SingleToInt32Bits($value));
      //             case TypeCode::Double: return Enum::ToObject($enumType, BitConverter.DoubleToInt64Bits($value));
      //             case TypeCode::Char: return Enum::ToObject($enumType, $value);
      //             case TypeCode::Boolean: return Enum::ToObject($enumType, $value ? 1 : 0);
      //       }

      //       $valueType = gettype($value);

      //       //if ( isAbstract($valueType)) $valueType = $valueType::GetEnumUnderlyingType();
      //       if ($valueType == "nint") Enum::ToObject($enumType, $value);
      //       if ($valueType == "nuint") Enum::ToObject($enumType, $value);
