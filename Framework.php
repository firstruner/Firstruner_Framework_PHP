...
class Framework
{
      public const FrameworkVersion = "3.1.81";
      ...
      public static function Load(bool $reload = false, bool $details = false, bool $passErrors = false)
      {
            ...
            Loader::Load(
                  [
                        ...
                        __DIR__ . '/Core/Firstruner/Classes/DNA/Commons/NonCodingBase.php',
                        __DIR__ . '/Core/Firstruner/Classes/DNA/Commons/DnaRules.php',
                        __DIR__ . '/Core/Firstruner/Classes/DNA/Bases/AbsNucleicBase.php',
                        __DIR__ . '/Core/Firstruner/Classes/DNA/Bases',
                        __DIR__ . '/Core/Firstruner/Classes/DNA/Validation',
                        __DIR__ . '/Core/Firstruner/Classes/DNA/Encoder',
                        __DIR__ . '/Core/Firstruner/Classes/DNA/Rules',
                        __DIR__ . '/Core/Firstruner/Classes/DNA/Brin.php',
                        __DIR__ . '/Core/Firstruner/Classes/DNA/Chromosome.php',
                        __DIR__ . '/Core/Firstruner/Classes/DNA/DNA_Structure.php',
                        __DIR__ . '/Core/Firstruner/Classes/DNA/Builders',
                        __DIR__ . '/Core/Firstruner/Classes/DNA/Factory',
                        __DIR__ . '/Core/Firstruner/Classes/DNA/Singleton',
                  ]
            );
